 ...
 * @author to cong hau
 */
@WebServlet(name = "GoListProductsAdminServlet", urlPatterns = {"/GoListProductsAdminServlet"})
public class GoListProductsAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String homepage = "./admin/product.jsp";
