 ...
 * @author to cong hau
 */
@WebServlet(name = "GoListManufacturersAdminServlet", urlPatterns = {"/GoListManufacturersAdminServlet"})
public class GoListManufacturersAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductDTO> listproducts = productBO.GetAllProducts();
        ...
        String homepage = "./admin/manufacturer.jsp";
