...
public class SearchProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductDTO> ls = productBO.searchProduct(nameSearch);
        ...
        session.setAttribute("listproducts", ls);
        RequestDispatcher rs = request.getRequestDispatcher("./admin/product.jsp");
