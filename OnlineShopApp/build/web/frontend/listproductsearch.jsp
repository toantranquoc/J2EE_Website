<%-- 
    ...
    Created on : Jun 17, 2020, 2:38:39 PM
    Author     : to cong hau
--%>
...
<html>
    ...
    <body>
        ...
        <form action="./SearchProductServlet" id="formSubmit" method="GET">
            <div class="d-flex justify-content-center mt-2">
                <ul class="pagination" id="pagination"></ul>
                <input type="hidden" value="${keyword}" id="nameSearch" name="nameSearch"/>
